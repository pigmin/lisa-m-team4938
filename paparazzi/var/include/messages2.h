...
static inline void DOWNLINK_SEND_GYRO_RATES(struct DownlinkTransport *tp, int16_t *_roll_adc, float *_roll, float *_pitch){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+2+4+4))) {
	  tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+2+4+4)); 
	  tp->StartMessage(tp->impl, "GYRO_RATES", DL_GYRO_RATES, 0+2+4+4); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT16, 2, (void *) _roll_adc); 
	  tp->PutBytes(tp->impl, DL_TYPE_FLOAT, 4, (void *) _roll); 
	  tp->PutBytes(tp->impl, DL_TYPE_FLOAT, 4, (void *) _pitch); 
	  tp->EndMessage(tp->impl); 
	} else 
...
static inline void DOWNLINK_SEND_FILTER_ALIGNER(struct DownlinkTransport *tp, int32_t *_lp_gp, int32_t *_lp_gq, int32_t *_lp_gr, int32_t *_gp, int32_t *_gq, int32_t *_gr, int32_t *_noise, int32_t *_cnt){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4+4+4+4+4+4))) {
	  ...
	  tp->StartMessage(tp->impl, "FILTER_ALIGNER", DL_FILTER_ALIGNER, 0+4+4+4+4+4+4+4+4); 
...
static inline void DOWNLINK_SEND_FILTER_Q(struct DownlinkTransport *tp, int32_t *_qi, int32_t *_qx, int32_t *_qy, int32_t *_qz){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4+4))) {
	  tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4+4)); 
	  tp->StartMessage(tp->impl, "FILTER_Q", DL_FILTER_Q, 0+4+4+4+4); 
...
static inline void DOWNLINK_SEND_BOOZ2_CMD(struct DownlinkTransport *tp, int32_t *_cmd_roll, int32_t *_cmd_pitch, int32_t *_cmd_yaw, int32_t *_cmd_thrust){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4+4))) {
	  tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4+4)); 
	  tp->StartMessage(tp->impl, "BOOZ2_CMD", DL_BOOZ2_CMD, 0+4+4+4+4); 
...
static inline void DOWNLINK_SEND_BOOZ2_TUNE_HOVER(struct DownlinkTransport *tp, int16_t *_rc_roll, int16_t *_rc_pitch, int16_t *_rc_yaw, int32_t *_cmd_roll, int32_t *_cmd_pitch, int32_t *_cmd_yaw, int32_t *_cmd_thrust, int32_t *_imu_phi, int32_t *_imu_theta, int32_t *_imu_psi, int32_t *_body_phi, int32_t *_body_theta, int32_t *_body_psi){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+2+2+2+4+4+4+4+4+4+4+4+4+4))) {
	  ...
	  tp->StartMessage(tp->impl, "BOOZ2_TUNE_HOVER", DL_BOOZ2_TUNE_HOVER, 0+2+2+2+4+4+4+4+4+4+4+4+4+4); 
...
static inline void DOWNLINK_SEND_BOOZ2_AHRS_EULER(struct DownlinkTransport *tp, int32_t *_imu_phi, int32_t *_imu_theta, int32_t *_imu_psi, int32_t *_body_phi, int32_t *_body_theta, int32_t *_body_psi){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4+4+4+4))) {
	  tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4+4+4+4)); 
	  tp->StartMessage(tp->impl, "BOOZ2_AHRS_EULER", DL_BOOZ2_AHRS_EULER, 0+4+4+4+4+4+4); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT32, 4, (void *) _imu_phi); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT32, 4, (void *) _imu_theta); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT32, 4, (void *) _imu_psi); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT32, 4, (void *) _body_phi); 
...
static inline void DOWNLINK_SEND_BOOZ2_AHRS_QUAT(struct DownlinkTransport *tp, int32_t *_imu_qi, int32_t *_imu_qx, int32_t *_imu_qy, int32_t *_imu_qz, int32_t *_body_qi, int32_t *_body_qx, int32_t *_body_qy, int32_t *_body_qz){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4+4+4+4+4+4))) {
	  tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4+4+4+4+4+4)); 
	  tp->StartMessage(tp->impl, "BOOZ2_AHRS_QUAT", DL_BOOZ2_AHRS_QUAT, 0+4+4+4+4+4+4+4+4); 
...
static inline void DOWNLINK_SEND_BOOZ2_AHRS_RMAT(struct DownlinkTransport *tp, int32_t *_imu_m00, int32_t *_imu_m01, int32_t *_imu_m02, int32_t *_imu_m10, int32_t *_imu_m11, int32_t *_imu_m12, int32_t *_imu_m20, int32_t *_imu_m21, int32_t *_imu_m22, int32_t *_body_m00, int32_t *_body_m01, int32_t *_body_m02, int32_t *_body_m10, int32_t *_body_m11, int32_t *_body_m12, int32_t *_body_m20, int32_t *_body_m21, int32_t *_body_m22){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4+4+4+4+4+4+4+4+4+4+4+4+4+4+4+4))) {
	  ...
	  tp->StartMessage(tp->impl, "BOOZ2_AHRS_RMAT", DL_BOOZ2_AHRS_RMAT, 0+4+4+4+4+4+4+4+4+4+4+4+4+4+4+4+4+4+4); 
...
static inline void DOWNLINK_SEND_BOOZ2_RADIO_CONTROL(struct DownlinkTransport *tp, int16_t *_roll, int16_t *_pitch, int16_t *_yaw, int16_t *_throttle, int16_t *_mode, int16_t *_kill, uint8_t *_status){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+2+2+2+2+2+2+1))) {
	  tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+2+2+2+2+2+2+1)); 
	  tp->StartMessage(tp->impl, "BOOZ2_RADIO_CONTROL", DL_BOOZ2_RADIO_CONTROL, 0+2+2+2+2+2+2+1); 
...
static inline void DOWNLINK_SEND_BOOZ_BARO_RAW(struct DownlinkTransport *tp, uint16_t *_offset, uint16_t *_value, uint16_t *_value_filtered){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+2+2+2))) {
	  tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+2+2+2)); 
	  tp->StartMessage(tp->impl, "BOOZ_BARO_RAW", DL_BOOZ_BARO_RAW, 0+2+2+2); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT16, 2, (void *) _offset); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT16, 2, (void *) _value); 
	  tp->PutBytes(tp->impl, DL_TYPE_UINT16, 2, (void *) _value_filtered); 
	  tp->EndMessage(tp->impl); 
	} else 
	  tp->Overrun(tp->impl); 
}
...
static inline void DOWNLINK_SEND_BOOZ_AHRS_BIAS(struct DownlinkTransport *tp, int32_t *_bp, int32_t *_bq, int32_t *_br){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4))) {
	  tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4)); 
	  tp->StartMessage(tp->impl, "BOOZ_AHRS_BIAS", DL_BOOZ_AHRS_BIAS, 0+4+4+4); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT32, 4, (void *) _bp); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT32, 4, (void *) _bq); 
	  tp->PutBytes(tp->impl, DL_TYPE_INT32, 4, (void *) _br); 
	  tp->EndMessage(tp->impl); 
...
static inline void DOWNLINK_SEND_BOOZ_SIM_SENSORS_SCALED(struct DownlinkTransport *tp, float *_acc_x, float *_acc_y, float *_acc_z, float *_mag_x, float *_mag_y, float *_mag_z){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4+4+4+4))) {
	  tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4+4+4+4)); 
	  tp->StartMessage(tp->impl, "BOOZ_SIM_SENSORS_SCALED", DL_BOOZ_SIM_SENSORS_SCALED, 0+4+4+4+4+4+4); 
...
static inline void DOWNLINK_SEND_WEATHER(struct DownlinkTransport *tp, float *_p_amb, float *_t_amb, float *_windspeed, float *_wind_from){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4+4))) {
	  tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4+4)); 
	  tp->StartMessage(tp->impl, "WEATHER", DL_WEATHER, 0+4+4+4+4); 
...
static inline void DOWNLINK_SEND_BOOZ_SIM_POS_LLH(struct DownlinkTransport *tp, float *_pprz_lat, float *_lat_geod, float *_lat_geoc, float *_pprz_lon, float *_lon, float *_pprz_alt, float *_alt_geod, float *_agl, float *_asl){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4+4+4+4+4+4+4))) {
	  tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4+4+4+4+4+4+4)); 
	  tp->StartMessage(tp->impl, "BOOZ_SIM_POS_LLH", DL_BOOZ_SIM_POS_LLH, 0+4+4+4+4+4+4+4+4+4); 
...
static inline void DOWNLINK_SEND_BOOZ_SIM_RPMS(struct DownlinkTransport *tp, float *_front, float *_back, float *_right, float *_left){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4+4))) {
	  tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4+4)); 
	  tp->StartMessage(tp->impl, "BOOZ_SIM_RPMS", DL_BOOZ_SIM_RPMS, 0+4+4+4+4); 
...
static inline void DOWNLINK_SEND_BOOZ_SIM_SPEED_POS(struct DownlinkTransport *tp, float *_ltpp_xdd, float *_ltpp_ydd, float *_ltpp_zdd, float *_ltpp_xd, float *_ltpp_yd, float *_ltpp_zd, float *_ltpp_x, float *_ltpp_y, float *_ltpp_z){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4+4+4+4+4+4+4))) {
	  tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4+4+4+4+4+4+4)); 
	  tp->StartMessage(tp->impl, "BOOZ_SIM_SPEED_POS", DL_BOOZ_SIM_SPEED_POS, 0+4+4+4+4+4+4+4+4+4); 
...
static inline void DOWNLINK_SEND_BOOZ_SIM_RATE_ATTITUDE(struct DownlinkTransport *tp, float *_p, float *_q, float *_r, float *_phi, float *_theta, float *_psi){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4+4+4+4))) {
	  tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4+4+4+4)); 
	  tp->StartMessage(tp->impl, "BOOZ_SIM_RATE_ATTITUDE", DL_BOOZ_SIM_RATE_ATTITUDE, 0+4+4+4+4+4+4); 
	  tp->PutBytes(tp->impl, DL_TYPE_FLOAT, 4, (void *) _p); 
	  tp->PutBytes(tp->impl, DL_TYPE_FLOAT, 4, (void *) _q); 
	  tp->PutBytes(tp->impl, DL_TYPE_FLOAT, 4, (void *) _r); 
	  tp->PutBytes(tp->impl, DL_TYPE_FLOAT, 4, (void *) _phi); 
...
static inline void DOWNLINK_SEND_BOOZ_SIM_GYRO_BIAS(struct DownlinkTransport *tp, float *_bp, float *_bq, float *_br){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4))) {
	  tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4)); 
	  tp->StartMessage(tp->impl, "BOOZ_SIM_GYRO_BIAS", DL_BOOZ_SIM_GYRO_BIAS, 0+4+4+4); 
	  tp->PutBytes(tp->impl, DL_TYPE_FLOAT, 4, (void *) _bp); 
	  tp->PutBytes(tp->impl, DL_TYPE_FLOAT, 4, (void *) _bq); 
	  tp->PutBytes(tp->impl, DL_TYPE_FLOAT, 4, (void *) _br); 
	  tp->EndMessage(tp->impl); 
...
static inline void DOWNLINK_SEND_BOOZ_SIM_RANGE_METER(struct DownlinkTransport *tp, float *_dist){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+4))) {
	  tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+4)); 
	  tp->StartMessage(tp->impl, "BOOZ_SIM_RANGE_METER", DL_BOOZ_SIM_RANGE_METER, 0+4); 
	  tp->PutBytes(tp->impl, DL_TYPE_FLOAT, 4, (void *) _dist); 
	  tp->EndMessage(tp->impl); 
	} else 
	  tp->Overrun(tp->impl); 
...
static inline void DOWNLINK_SEND_BOOZ_SIM_WIND(struct DownlinkTransport *tp, float *_vx, float *_vy, float *_vz){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4))) {
	  tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4)); 
	  tp->StartMessage(tp->impl, "BOOZ_SIM_WIND", DL_BOOZ_SIM_WIND, 0+4+4+4); 
	  tp->PutBytes(tp->impl, DL_TYPE_FLOAT, 4, (void *) _vx); 
	  tp->PutBytes(tp->impl, DL_TYPE_FLOAT, 4, (void *) _vy); 
	  tp->PutBytes(tp->impl, DL_TYPE_FLOAT, 4, (void *) _vz); 
	  tp->EndMessage(tp->impl); 
...
static inline void DOWNLINK_SEND_BOOZ_SIM_ACCEL_LTP(struct DownlinkTransport *tp, float *_xdd, float *_ydd, float *_zdd){ 
	if (tp->CheckFreeSpace(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4))) {
	  tp->CountBytes(tp->impl, tp->SizeOf(tp->impl, 0+4+4+4)); 
	  tp->StartMessage(tp->impl, "BOOZ_SIM_ACCEL_LTP", DL_BOOZ_SIM_ACCEL_LTP, 0+4+4+4); 
	  tp->PutBytes(tp->impl, DL_TYPE_FLOAT, 4, (void *) _xdd); 
	  tp->PutBytes(tp->impl, DL_TYPE_FLOAT, 4, (void *) _ydd); 
...
void DOWNLINK_SEND_GYRO_RATES(struct DownlinkTransport *tp, int16_t *_roll_adc, float *_roll, float *_pitch) {}
...
void DOWNLINK_SEND_FILTER_ALIGNER(struct DownlinkTransport *tp, int32_t *_lp_gp, int32_t *_lp_gq, int32_t *_lp_gr, int32_t *_gp, int32_t *_gq, int32_t *_gr, int32_t *_noise, int32_t *_cnt) {}
void DOWNLINK_SEND_FILTER_Q(struct DownlinkTransport *tp, int32_t *_qi, int32_t *_qx, int32_t *_qy, int32_t *_qz) {}
...
void DOWNLINK_SEND_BOOZ2_CMD(struct DownlinkTransport *tp, int32_t *_cmd_roll, int32_t *_cmd_pitch, int32_t *_cmd_yaw, int32_t *_cmd_thrust) {}
...
void DOWNLINK_SEND_BOOZ2_TUNE_HOVER(struct DownlinkTransport *tp, int16_t *_rc_roll, int16_t *_rc_pitch, int16_t *_rc_yaw, int32_t *_cmd_roll, int32_t *_cmd_pitch, int32_t *_cmd_yaw, int32_t *_cmd_thrust, int32_t *_imu_phi, int32_t *_imu_theta, int32_t *_imu_psi, int32_t *_body_phi, int32_t *_body_theta, int32_t *_body_psi) {}
...
void DOWNLINK_SEND_BOOZ2_AHRS_EULER(struct DownlinkTransport *tp, int32_t *_imu_phi, int32_t *_imu_theta, int32_t *_imu_psi, int32_t *_body_phi, int32_t *_body_theta, int32_t *_body_psi) {}
void DOWNLINK_SEND_BOOZ2_AHRS_QUAT(struct DownlinkTransport *tp, int32_t *_imu_qi, int32_t *_imu_qx, int32_t *_imu_qy, int32_t *_imu_qz, int32_t *_body_qi, int32_t *_body_qx, int32_t *_body_qy, int32_t *_body_qz) {}
void DOWNLINK_SEND_BOOZ2_AHRS_RMAT(struct DownlinkTransport *tp, int32_t *_imu_m00, int32_t *_imu_m01, int32_t *_imu_m02, int32_t *_imu_m10, int32_t *_imu_m11, int32_t *_imu_m12, int32_t *_imu_m20, int32_t *_imu_m21, int32_t *_imu_m22, int32_t *_body_m00, int32_t *_body_m01, int32_t *_body_m02, int32_t *_body_m10, int32_t *_body_m11, int32_t *_body_m12, int32_t *_body_m20, int32_t *_body_m21, int32_t *_body_m22) {}
...
void DOWNLINK_SEND_BOOZ2_RADIO_CONTROL(struct DownlinkTransport *tp, int16_t *_roll, int16_t *_pitch, int16_t *_yaw, int16_t *_throttle, int16_t *_mode, int16_t *_kill, uint8_t *_status) {}
void DOWNLINK_SEND_BOOZ_BARO_RAW(struct DownlinkTransport *tp, uint16_t *_offset, uint16_t *_value, uint16_t *_value_filtered) {}
...
void DOWNLINK_SEND_BOOZ_AHRS_BIAS(struct DownlinkTransport *tp, int32_t *_bp, int32_t *_bq, int32_t *_br) {}
...
void DOWNLINK_SEND_BOOZ_SIM_SENSORS_SCALED(struct DownlinkTransport *tp, float *_acc_x, float *_acc_y, float *_acc_z, float *_mag_x, float *_mag_y, float *_mag_z) {}
...
void DOWNLINK_SEND_WEATHER(struct DownlinkTransport *tp, float *_p_amb, float *_t_amb, float *_windspeed, float *_wind_from) {}
...
void DOWNLINK_SEND_BOOZ_SIM_POS_LLH(struct DownlinkTransport *tp, float *_pprz_lat, float *_lat_geod, float *_lat_geoc, float *_pprz_lon, float *_lon, float *_pprz_alt, float *_alt_geod, float *_agl, float *_asl) {}
void DOWNLINK_SEND_BOOZ_SIM_RPMS(struct DownlinkTransport *tp, float *_front, float *_back, float *_right, float *_left) {}
void DOWNLINK_SEND_BOOZ_SIM_SPEED_POS(struct DownlinkTransport *tp, float *_ltpp_xdd, float *_ltpp_ydd, float *_ltpp_zdd, float *_ltpp_xd, float *_ltpp_yd, float *_ltpp_zd, float *_ltpp_x, float *_ltpp_y, float *_ltpp_z) {}
void DOWNLINK_SEND_BOOZ_SIM_RATE_ATTITUDE(struct DownlinkTransport *tp, float *_p, float *_q, float *_r, float *_phi, float *_theta, float *_psi) {}
void DOWNLINK_SEND_BOOZ_SIM_GYRO_BIAS(struct DownlinkTransport *tp, float *_bp, float *_bq, float *_br) {}
void DOWNLINK_SEND_BOOZ_SIM_RANGE_METER(struct DownlinkTransport *tp, float *_dist) {}
void DOWNLINK_SEND_BOOZ_SIM_WIND(struct DownlinkTransport *tp, float *_vx, float *_vy, float *_vz) {}
...
void DOWNLINK_SEND_BOOZ_SIM_ACCEL_LTP(struct DownlinkTransport *tp, float *_xdd, float *_ydd, float *_zdd) {}
